<?php
/**
 * Template Name: C-Portfolio Template Waterfall Flux with AJAX
 *
 * @since alterna 8.0
 */
...
<div id="main" class="container aja">
  <div class="row">
    ...
    <?php if($layout != 1) { ?>
    <aside class="alterna-col col-lg-3 col-md-4 col-sm-4 alterna-<?php echo $layout_class;?>">
      ...
      <div class="clear"></div>
      <?php generated_dynamic_sidebar(); ?></aside>
      <?php } ?>
    </div>
  </div>
  <?php get_footer(); ?>
