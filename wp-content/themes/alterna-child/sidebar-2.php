...
<h3 class="widget-title"><?php _e('検索','alterna'); ?></h3><div class="line"></div><div class="clear"></div>
  <?php echo do_shortcode('[searchandfilter id="3038"]' ); ?>
</div>
<h3 class="widget-title"><?php _e('この記事の情報','alterna'); ?></h3><div class="line"></div><div class="clear"></div>
...
<div id="tax_country" class="widget widget_categories">
  <h3 class="widget-title">国別カテゴリ</h3><div class="line"></div><div class="clear"></div>
  <ul>
    <?php
