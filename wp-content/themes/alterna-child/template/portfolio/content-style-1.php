...
<div class="portfolio-wrap s1">
  ...
  if($portfolio_type == 1) {
    ...
    <div class="post-tip">
      ...
      <a href="<?php echo esc_url(get_permalink()); ?>"><div class="link left-link" title="記事へ"><i class="big-icon-link"></i></div></a>
      <a href="<?php echo esc_url($full_image[0]); ?>" class="fancyBox" title="拡大画像"><div class="link right-link"><i class="big-icon-preview"></i></div></a>
    </div>
    <?php
  }
  ?>
...
<div class="portfolio-content">
  <header>
    ...
    <h5 class="entry-title" itemprop="name"><a href="<?php echo esc_url(get_permalink()); ?>" itemprop="url" title="記事へ"><?php the_title(); ?></a></h5>
    <?php }else{ ?>
    <h4 class="entry-title" itemprop="name" title="記事へ"><a href="<?php echo esc_url(get_permalink()); ?>" itemprop="url"><?php the_title(); ?></a></h4>
    <?php } ?>
    <span class="portfolio-categories" itemprop="genre">
