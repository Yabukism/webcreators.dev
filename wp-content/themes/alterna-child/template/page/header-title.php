...
<?php
          ...
          (is_tax() && taxonomy_exists('portfolio_categories') && $current_tax == "portfolio_categories") ||
          (is_tax() && taxonomy_exists('country') && $current_tax == "country") ||
          (is_tax() && taxonomy_exists('era-name') && $current_tax == "era-name") ||
          (is_tax() && taxonomy_exists('historyart') && $current_tax == "historyart") ||
          (is_tax() && taxonomy_exists('historybuilding') && $current_tax == "historybuilding") ||
          (is_tax() && taxonomy_exists('historypeople') && $current_tax == "historypeople") ||
          (is_tax() && taxonomy_exists('historyformat') && $current_tax == "historyformat") ||

          is_category() || is_tag() || is_404() || is_search() || is_date() || is_author()) {
            ?>
            <div id="page-header">
              <div class="top-shadow"></div>
              <div  class="container">
