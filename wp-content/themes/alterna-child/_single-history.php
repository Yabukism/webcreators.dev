<?php
/**
 * Template Name: xHistory Single Page
 *
 * @since alterna 8.0
 */
get_header();
...
?>
<div id="main" class="container single-history">
 <div class="row">
      ...
      if($tags && count($tags) > 0) {
        ...
        <div class="post-about-author">
          ...
          <div class="post-related">
            <?php echo do_shortcode('[related_posts_by_tax  format="thumbnails" image_size="alterna-square-thumbs"]'); ?>
          </div>
          <?php } ?>
