...
class adsensem_admin {
		...
		function init_admin()
		{
			...
			add_submenu_page('edit.php',"Ad Units", "Ad Units", administrator, "adsense-manager-manage-ads", array('adsensem_admin','admin_manage'));
			add_options_page("AdSense Manager Options", "AdSense Manager", administrator, "adsense-manager-options", array('adsensem_admin','admin_options'));
